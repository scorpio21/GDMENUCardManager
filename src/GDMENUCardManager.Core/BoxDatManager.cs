...
namespace GDMENUCardManager.Core
{
    ...
    public class BoxDatManager
    {
        ...
        /// <summary>
        /// Merges entries from another BoxDatManager into this one.
        /// </summary>
        public void Merge(BoxDatManager other, bool overwriteExisting = false)
        {
            ...
            foreach (var otherEntry in other._entries)
            {
                ...
                if (existingEntry == null)
                {
                    ...
                    _entries.Add(newEntry);
                    _serialsWithArtwork.Add(newEntry.Name);
                    HasUnsavedChanges = true;
                }
